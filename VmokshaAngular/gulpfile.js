...
gulp.task('styles', ['clean-styles','styles-less','styles-sass'], function() {
...
gulp.task('fonts', ['clean-fonts'], function() {
    ...
    return gulp
        .src([config.fonts,config.fontscustom])
...
gulp.task('font', ['clean-font'], function () {
    log('Copying mdbootstrap fonts');

    return gulp
        .src([config.mdbootstrapfont, config.fontcustom])
...
gulp.task('optimize', ['inject', 'fonts','font','data', 'images'], function() {
