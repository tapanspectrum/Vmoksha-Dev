/* Description: The Pagination Directive deals with calling pagination apis on click of pagination grid and maintaining pagewise results for elastic search.
 * Author:  
 * Created On: 
 * Modified For: 
 * Modified On:
...
'use strict';
angular.module('app.widgets').directive('elasticsearchPagination', ['$window', 'PaginationElasticSearchService', '$location', '$rootScope', '$timeout', function ($window, PaginationElasticSearchService, $location, $rootScope, $timeout) {
return {
        restict: 'E',
        ...
        templateUrl: "app/widgets/paginationelasticsearch/PaginationElasticSearch.html", 
        link: function (scope, element, attrs) {
            ...
            scope.gotoNextPage = function (p) {
                ...
                PaginationElasticSearchService.navigate(scope.pageindex, newURL)
            ...
            scope.gotoPage = function (p) {
                PaginationElasticSearchService.navigate(p, newURL)

            };
            //Swathi(14-Oct-15): The below event is fired when search is clicked to set pages array and page index
            $rootScope.$on('ResetServerSidePaginationElasticSearch', function (i, args) {
                scope.pages = [];
                scope.pageindex = 1;
            });
            //ends
