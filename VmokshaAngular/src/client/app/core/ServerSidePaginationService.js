 ...
 * Modified For: Included error handling
...
angular
    .module('app.core')
    .factory('ServerSidePaginationService', ['$http', '$q', 'DTOptionsBuilder', 'DTColumnDefBuilder', '$rootScope', 'vmuisettings', function ($http, $q, DTOptionsBuilder, DTColumnDefBuilder, $rootScope, vmuisettings) {
    ...
    return {
        ...
        load: function (pageNumber, serversideUrl, params) {
            ...
            $http({
                url: vmuisettings.ApiUrl + serversideUrl + '?limit=' + paginationServiceParams.paging.ssp_info.limit + '&page=' + pageNumber
