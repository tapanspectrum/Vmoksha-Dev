 ...
 * Author:  Kirti 
 * Created On: 16/1/2017- 17/1/2017
 * Modified For: 
 * Modified On:
 * Modified By:
 * */
    ...
    function getStates(vmuisettings) {        
        return [           
...

            {
                ...
                config: {
                    url:  '/services/infrastructure-management-services/remote-infrastructure-management/',
                    title: '/',
                    settings: {
                        nav: 1
                    },
            ...
            },
            {
                state: 'rim_offerings',
                config: {
                    url:  '/sservices/infrastructure-management-services/rim-offerings',
                    title: '/',
                    settings: {
                        nav: 1
                    },
            ...
            },
            {
                ...
                config: {
                    url:  '/services/infrastructure-management-services/business-benefits-2',
                    title: '/',
                    settings: {
                        nav: 1
                    },
            ...
            {
                state: 'it_staffing_services',
                config: {
                    url:  '/services/it-staffing-services',
                    title: '/',
                    settings: {
                        nav: 1
                    },
                    views: {
                        ...
                        'content': {
                            templateUrl: 'app/services/it_staffing_services.html',
                            controller: 'Services',
                            controllerAs: 'vm'
                        },
                        'footer': {
            ...
            {
                state: 'digital_marketing_services',
                config: {
                    ...
                    views: {
                        ...
                        'content': {
                            templateUrl: 'app/services/digital_marketing_services.html',
                            controller: 'Services',
                            controllerAs: 'vm'
                        },
                        'footer': {
